...
declare -A PACKAGES=(
    ["MC.Logging/AnointedAutomation.Logging.csproj"]="anointedautomation.logging"
    ["MC.Memory/AnointedAutomation.Memory.csproj"]="anointedautomation.memory"
    ["MC.APIMiddlewares/AnointedAutomation.APIMiddlewares.csproj"]="anointedautomation.apimiddlewares"
    ["MC.Repository.Mongo/AnointedAutomation.Repository.Mongo.csproj"]="anointedautomation.repository.mongo"
    ["MC.Objects/AnointedAutomation.Objects.csproj"]="anointedautomation.objects"
    ["MC.Objects.API/AnointedAutomation.Objects.API.csproj"]="anointedautomation.objects.api"
)
